...
const projectsData: { [key: string]: any } = {
  ...
  "6": {
    title: "ELEVATE",
    description:
      "Stage au sein d'ELEVATE, dans lequel j'ai réalisé une maquette web, un logo ainsi qu'une mascotte.",
    fullDescription:
      "Stage au sein d'ELEVATE, dans lequel j'ai réalisé une maquette web, un logo ainsi qu'une mascotte.",
    tags: ["Figma", "Illustrator", "After Effect", "Premiere Pro", "Photoshop"],
    image: "/Elevate.png?height=600&width=1200",
    galleryImages: ["/Elevate2.png?height=300&width=600", "/Setting.png?height=300&width=600"],
  
    // demoUrl: "",
    // repoUrl: "",
    features: [
      "Conception graphique de l'interface web",
      "Création d'un logo distinctif",
      "Création d'une mascotte pour le SAT",
    ],
    challenge:
      "Le défi était de transposer les Self Assessment Tools d'ELEVATE initialement au format PDF en une application web interactive et dynamique.",
    solution: [
      "Faire validée la direction artistique par les collaborateurs européens d'ELEVATE",
